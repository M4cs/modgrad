...
export function blobBackground(l) {
    ...
    return `radial-gradient(circle at ${l.x.toFixed(2)}% ${l.y.toFixed(2)}%, ${stops})`;
}
/** Non-mesh variants render as one flat background string. */
export function flatBackground(variant, layers, angle) {
